                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="time" class="form-control @error('waktu_mulai_acara') is-invalid @enderror" id="waktu_mulai_acara" name="waktu_mulai_acara" value="{{ old('waktu_mulai_acara') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('lokasi_acara') is-invalid @enderror" id="lokasi_acara" name="lokasi_acara" value="{{ old('lokasi_acara') }}" placeholder="Contoh: Gedung Serbaguna, Jakarta">
                            @error('lokasi_acara')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('deskripsi_acara') is-invalid @enderror" id="deskripsi_acara" name="deskripsi_acara" rows="4" placeholder="Jelaskan detail acara... Adanya permintaan khusus dll.">{{ old('deskripsi_acara') }}</textarea>
                        ...
                        <div id="items-container">
                            <div class="item-row border rounded p-3 mb-3 bg-light">
                                ...
                                <div class="mb-0">
                                    ...
                                    <input type="number" name="items[0][jumlah]" class="form-control jumlah-input" value="1" min="1" required>
                                </div>
                            </div>
                        </div>
