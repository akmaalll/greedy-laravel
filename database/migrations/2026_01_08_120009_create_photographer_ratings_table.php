...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_rating_fotografer', function (Blueprint $table) {
            $table->id();
            ...
            $table->index('fotografer_id');
            $table->index('rating');
            $table->unique(['pesanan_id', 'fotografer_id']); // Satu pesanan hanya bisa rating fotografer sekali
        });
    }
    ...
    {
        Schema::dropIfExists('tbl_rating_fotografer');
    }
};
